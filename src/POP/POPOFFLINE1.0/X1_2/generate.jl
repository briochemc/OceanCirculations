...
mat_MET_file = joinpath(data_path, "abardin/POPOFFLINE1.0/X1_2/MET.mat")
grd = matread(mat_MET_file)["MET"]

println("Reading MTM0 file (circulation matrix)")
mat_MTM0_file = joinpath(data_path, "abardin/POPOFFLINE1.0/X1_2/MTM0.mat")
...
bson_file = joinpath(bson_dir, "AIBECS-POP1_2x2.bson")
