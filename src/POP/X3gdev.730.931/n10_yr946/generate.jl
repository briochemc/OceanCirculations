...
mat_MET_file = "/Users/benoitpasquier/Data/abardin/POPOFFLINE_ops/X3gdev.730.931/n10_yr946/MET.mat"
grd = matread(mat_MET_file)["MET"]

println("Reading MTM0 file (circulation matrix)")
mat_MTM0_file = "/Users/benoitpasquier/Data/abardin/POPOFFLINE_ops/X3gdev.730.931/n10_yr946/MTM0.mat"
vars = matread(mat_MTM0_file)

println("  Circulation (T = A + H + D)")
T = -vars["T"] * upreferred(u"1/yr") # TODO check unit and direction is correct!
A = -vars["A"] * upreferred(u"1/yr") # TODO check unit and direction is correct!
H = -vars["H"] * upreferred(u"1/yr") # TODO check unit and direction is correct!
D = -vars["D"] * upreferred(u"1/yr") # TODO check unit and direction is correct!
